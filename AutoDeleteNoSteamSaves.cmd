@echo off
title Pylar's Auto Delete NoSteam Saves
...
:: Check if AutoDeleteNoSteamSaves.py exists
if not exist "AutoDeleteNoSteamSaves.py" (
    exit /B 1
)
...
echo Executing AutoDeleteNoSteamSaves.py using !PYTHON_PATH!...
"!PYTHON_PATH!" AutoDeleteNoSteamSaves.py
pause